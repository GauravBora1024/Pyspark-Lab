...
def loadMovieNames():
    ...
    with codecs.open(r"D:\gitHub\Pyspark-Lab\Machine Learning\Produce Movie Reccomendation\u.item", "r", encoding='ISO-8859-1', errors='ignore') as f:
        for line in f:
            fields = line.split('|')
...
ratings = spark.read.option("sep", "\t").schema(moviesSchema) \
    .csv(r"D:\gitHub\Pyspark-Lab\Machine Learning\Produce Movie Reccomendation\u.data")
